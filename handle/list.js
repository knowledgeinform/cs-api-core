...
module.exports = {
    handle: ({service, key, subkey, body, res}) => {
        ...
        if (typeof service.obj[key][subkey].value === 'number') {
            ...
            res.send()
          } else if (typeof service.obj[key][subkey].value === 'string') {
            console.debug('Found list string')
            if (csdt.isSetter(service.obj[key], subkey)) {
            ...
            console.debug('Unknown list type')
